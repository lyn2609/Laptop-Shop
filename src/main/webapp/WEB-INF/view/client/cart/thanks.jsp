                ...
                <div class="container" style="margin-top: 120px; margin-bottom: 80px;">
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-lg-6">
                            <div class="card text-center shadow-sm" style="border: 2px solid #28a745;">
                                <div class="card-body p-5">
                                    ...
                                    <p class="text-muted mb-4">
                                        Cảm ơn bạn đã mua hàng tại Laptopshop. Đơn hàng của bạn đã được xác nhận và đang được xử lý.
                                    </p>
                                    <p class="text-muted mb-4">
                                    ...
                                    <div class="d-flex gap-3 justify-content-center mt-4 flex-wrap">
                                        ...
                                        <a href="/order-history" class="btn btn-outline-primary px-4 py-2 rounded-pill">
                                            <i class="fa fa-list-alt me-2"></i>Xem đơn hàng
                                        </a>
                                    </div>
                                </div>
                            </div>
